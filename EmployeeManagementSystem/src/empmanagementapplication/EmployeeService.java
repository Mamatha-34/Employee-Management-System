...
public class EmployeeService {
	...
	Employee emp2 = new Employee(102, "Meena",26,"Developer","CO", 57000);
	Employee emp3 = new Employee(103, "Bob",20,"Developer","Admin", 50000);
		...
		public void updateEmployee() {
			...
			for(Employee emp:empset)
			{
				if(emp.getId()==id)
				{
					...
					emp.setName(name);
					emp.setSalary(sal);
					System.out.println("Upload details of Employee are: ");
					System.out.println(emp);
					found = true;
			     }
	     	}
